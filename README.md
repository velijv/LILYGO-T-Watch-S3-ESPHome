...
<details>
<summary> <h3> Technical details 🧑‍💻 + <a href="static/datasheets">datasheets 📚 </a></h3> </summary>
...
<table>
	<caption>graphical_display_menu, ble_improv, wifi_ap QR</caption>
	<tr>
		<td><img alt="Home & Global Header" src="static/screen_server/index.bmp"></td>
		<td><img alt="Graphical Display Menu" src="static/screen_server/menu.bmp"></td>
		<td><img alt="Graphical Display Menu" src="static/screen_server/menu-open.bmp"></td>
		<td><img alt="Bluetooth / Improv / Access Point" src="static/screen_server/improv.bmp"></td>
	</tr>
</table>

<table>
	<caption>Watch faces</caption>
	<tr>
		<td><img alt="" src="static/screen_server/watch.bmp"></td>
		<td><img alt="" src="static/screen_server/watch-color.bmp"></td>
		<td><img alt="" src="static/screen_server/watch-face.bmp"></td>
	</tr>
</table>
...
<table>
	<tr>
		<td><img alt="online_image" src="static/screen_server/image-online.bmp"></td>
		<td><img alt="Spotify Albym Art" src="static/screen_server/image-spotify.bmp"></td>
		<td><img alt="Color test" src="static/screen_server/test-color.bmp"></td>
	</tr>
	<tr>
	</tr>
</table>
